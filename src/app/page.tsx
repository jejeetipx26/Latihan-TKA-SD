      ...
      <div className="min-h-screen bg-[#FFF8DE] p-6 font-sans">
        <div className="max-w-6xl mx-auto">
          <div className="flex justify-between items-center mb-8 bg-white p-6 rounded-2xl shadow-sm border border-[#0F2854]/5">
            ...
            <div className="flex gap-3"><button onClick={fetchTeacherData} className="flex items-center gap-2 px-5 py-3 bg-[#FFF8DE] text-[#0F2854] border border-[#0F2854]/20 rounded-xl font-bold hover:bg-[#0F2854] hover:text-[#FFF8DE] transition"><RefreshCcw className={`w-4 h-4 ${isLoadingData?'animate-spin':''}`} /> Refresh</button><button onClick={handleLogout} className="flex items-center gap-2 px-5 py-3 bg-red-50 text-red-600 border border-red-100 rounded-xl font-bold hover:bg-red-100 transition"><LogOut size={18}/> Keluar</button></div>
          </div>
